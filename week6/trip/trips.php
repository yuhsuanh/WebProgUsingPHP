    ...
    <table id="listing" class="table table-striped table-hover table-bordered">
        ...
        <?php foreach($trips as $trip) { ?>
            <tr>
                ...
                <td><a class="btn btn-primary" href="trip.php?trip_id=<?php echo $trip['trip_id']; ?>">Edit <i class="fas fa-edit"></i></a></td>
                <td><a class="delete_trip btn btn-danger" href="delete-trip.php?trip_id=<?php echo $trip['trip_id']; ?>">Delete <i class="fas fa-trash-alt"></i></a></td>
            </tr>
        <?php } ?>
        </tbody>
    </table>
